...
describe('toMaintenanceListApiParams', () => {
  it('page を 0 始まりへ、serverId null は省く', () => {
    expect(toMaintenanceListApiParams(DEFAULT_MAINTENANCE_LIST_PARAMS)).toEqual({
      serverId: undefined,
      sort: 'performedDate',
      order: 'desc',
      page: 0,
    ...
    expect(
      toMaintenanceListApiParams({ ...DEFAULT_MAINTENANCE_LIST_PARAMS, serverId: 7, page: 3 }),
