...
/**
 * {@link MaintenanceHistoryService} の実装（詳細設計 04-maintenance §4・§5、FR-MNT-01〜03）。
 *
...
public class MaintenanceHistoryServiceImpl implements MaintenanceHistoryService {
  ...
  private static final Logger log = LoggerFactory.getLogger(MaintenanceHistoryServiceImpl.class);

  private final MaintenanceHistoryDao maintenanceHistoryDao;
  private final ServerDao serverDao;

  public MaintenanceHistoryServiceImpl(
